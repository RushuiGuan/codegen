# TableUpdateExcludePrimaryKey Properties
 

The <a href="T_Albatross_CodeGen_SqlServer_TableUpdateExcludePrimaryKey.md">TableUpdateExcludePrimaryKey</a> type exposes the following members.
