...
class MyDto(BaseModel):
	...
	nullable_string_value: None|str = Field(alias = "nullableStringValue")
	nullable_string_array: list[None|str] = Field(alias = "nullableStringArray")
...
class ReferenceType(BaseModel):
	...
	nullable_string: None|str = Field(alias = "nullableString")
