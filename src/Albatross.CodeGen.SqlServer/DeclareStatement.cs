...
namespace Albatross.CodeGen.SqlServer {
	...
	public class DeclareStatement : CodeGeneratorBase<object, SqlCodeGenOption>{
		...
		public override IEnumerable<object>  Build(StringBuilder sb, object src, SqlCodeGenOption options) {
			List<object> list = new List<object> { this };

			StringBuilder child = new StringBuilder();
			var items = InvokeYield(child);
