...
{
	public class WriteCSharpProperty : IWriteObject<Property> {
		IWriteObject<AccessModifier> writeAccessModifier;
		IWriteObject<DotNetType> writeType;

		public WriteCSharpProperty(IWriteObject<AccessModifier> renderAccessModifier, IWriteObject<DotNetType> renderType) {
