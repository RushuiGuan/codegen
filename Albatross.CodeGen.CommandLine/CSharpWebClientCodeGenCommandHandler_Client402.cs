...
namespace Albatross.CodeGen.CommandLine {
	[Obsolete]
	public class CSharpWebClientCodeGenCommandHandler_Client402 : CommandAction<CodeGenCommandOptions> {
		...
		public CSharpWebClientCodeGenCommandHandler_Client402(CodeGenCommandOptions options,
