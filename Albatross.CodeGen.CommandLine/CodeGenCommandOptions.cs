...
namespace Albatross.CodeGen.CommandLine {
	[Verb("csharp-proxy", typeof(CSharpWebClientCodeGenCommandHandler_Client800), Description = "Generate CSharp Http Proxy class that works with the current version of Albatross.WebClient assembly")]
	[Verb("csharp-proxy-client740", typeof(CSharpWebClientCodeGenCommandHandler_Client740), Description = "Generate CSharp Http Proxy class that works with Albatross.WebClient assembly version 7.4.*")]
