...
namespace Albatross.CodeGen.CommandLine {
	[Obsolete]
	public class CSharpWebClientCodeGenCommandHandler_Client800 : CommandAction<CodeGenCommandOptions> {
		private readonly CreateHttpClientRegistrations createHttpClientRegistrations;
		private readonly Compilation compilation;
		private readonly CodeGenSettings settings;
		private readonly ILogger<CSharpWebClientCodeGenCommandHandler_Client800> logger;
		private readonly ConvertApiControllerToControllerModel convertToWebApi;
		private readonly ConvertWebApiToCSharpCodeStack_Client800 converToCSharpCodeStack;

		public CSharpWebClientCodeGenCommandHandler_Client800(CodeGenCommandOptions options,
			CreateHttpClientRegistrations createHttpClientRegistrations,
			Compilation compilation,
			CodeGenSettings settings,
			ILogger<CSharpWebClientCodeGenCommandHandler_Client800> logger,
			ConvertApiControllerToControllerModel convertToWebApi,
			ConvertWebApiToCSharpCodeStack_Client800 converToCSharpFile) : base(options) {
