...
namespace Albatross.DbScripting.SqlServer {
	public class TableMergeByID : ITableBasedQuery {
		public string Scenario => "table_merge_by_id";
		public string Description => "Composite: merge statement with the source joined by the identity column";
