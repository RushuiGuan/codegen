...
namespace Albatross.DbScripting.SqlServer {
	public class TableMergeWithAuditByPrimaryKey : ITableBasedQuery {
		public string Scenario => "table_merge_w_audit_by_primarykey";
		public string Description => "Composite: merge statement with audit in its select clause and joined by the primary key columns";
