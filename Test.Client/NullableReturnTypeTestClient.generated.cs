...
namespace Test.Client {
	public partial class NullableReturnTypeTestClient {
		...
		public async Task<string?> GetString(string? text, CancellationToken cancellationToken) {
			...
			return await this.client.Execute<string?>(requestMsg, this.jsonSerializerOptions, cancellationToken);
		}
		...
		public async Task<System.Nullable<int>> GetInt(System.Nullable<int> n, CancellationToken cancellationToken) {
			...
			using var requestMsg = builder.Build();
			return await this.client.Execute<System.Nullable<int>>(requestMsg, this.jsonSerializerOptions, cancellationToken);
		}
		...
		public async Task<System.Nullable<System.DateTime>> GetDateTime(System.Nullable<System.DateTime> v, CancellationToken cancellationToken) {
			...
			using var requestMsg = builder.Build();
			return await this.client.Execute<System.Nullable<System.DateTime>>(requestMsg, this.jsonSerializerOptions, cancellationToken);
		}
		...
		public async Task<Test.Dto.Classes.MyDto?> GetMyDto(Test.Dto.Classes.MyDto? value, CancellationToken cancellationToken) {
			...
			using var requestMsg = builder.Build();
			return await this.client.Execute<Test.Dto.Classes.MyDto?>(requestMsg, this.jsonSerializerOptions, cancellationToken);
		}
