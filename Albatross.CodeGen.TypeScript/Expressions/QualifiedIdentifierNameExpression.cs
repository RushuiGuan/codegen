...
namespace Albatross.CodeGen.TypeScript.Expressions {
	public record class QualifiedIdentifierNameExpression : CodeNode, IIdentifierNameExpression {
		...
		public override IEnumerable<ICodeNode> Children => [Identifier, Source];
