...
namespace Test.WithInterface.Client {
	public partial interface IRequiredParamTestClient {
		Task<string> ExplicitStringParam(string text, CancellationToken cancellationToken);
		Task<string> ImplicitStringParam(string text, CancellationToken cancellationToken);
		Task<string> RequiredStringParam(string text, CancellationToken cancellationToken);
		Task<string> RequiredValueType(int id, CancellationToken cancellationToken);
		Task<string> RequiredDateOnly(System.DateOnly date, CancellationToken cancellationToken);
		Task<string> RequiredDateTime(System.DateTime date, CancellationToken cancellationToken);
		Task RequiredPostParam(Test.Dto.Classes.MyDto dto, CancellationToken cancellationToken);
		Task<string> RequiredStringArray(string[] values, CancellationToken cancellationToken);
		Task<string> RequiredStringCollection(System.Collections.Generic.IEnumerable<string> values, CancellationToken cancellationToken);
		Task<string> RequiredValueTypeArray(int[] values, CancellationToken cancellationToken);
		Task<string> RequiredValueTypeCollection(System.Collections.Generic.IEnumerable<int> values, CancellationToken cancellationToken);
		Task<string> RequiredDateOnlyCollection(System.Collections.Generic.IEnumerable<System.DateOnly> dates, CancellationToken cancellationToken);
		Task<string> RequiredDateOnlyArray(System.DateOnly[] dates, CancellationToken cancellationToken);
		Task<string> RequiredDateTimeCollection(System.Collections.Generic.IEnumerable<System.DateTime> dates, CancellationToken cancellationToken);
		Task<string> RequiredDateTimeArray(System.DateTime[] dates, CancellationToken cancellationToken);
		Task<Test.Dto.Enums.MyEnum> RequiredEnum(Test.Dto.Enums.MyEnum value, CancellationToken cancellationToken);
		Task<Test.Dto.Enums.MyEnum[]> RequiredEnumArray(Test.Dto.Enums.MyEnum[] values, CancellationToken cancellationToken);
	}
	public partial class RequiredParamTestClient : IRequiredParamTestClient {
		public RequiredParamTestClient(HttpClient client) {
			this.client = client;
