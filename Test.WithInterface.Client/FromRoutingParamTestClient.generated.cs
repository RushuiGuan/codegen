...
namespace Test.WithInterface.Client {
	public partial interface IFromRoutingParamTestClient {
		Task<int> GetTenantId(string tenant, CancellationToken cancellationToken);
		Task ImplicitRoute(string tenant, string name, int id, CancellationToken cancellationToken);
		Task ExplicitRoute(string tenant, string name, int id, CancellationToken cancellationToken);
		Task WildCardRouteDouble(string tenant, string name, int id, CancellationToken cancellationToken);
		Task WildCardRouteSingle(string tenant, string name, int id, CancellationToken cancellationToken);
		Task DateTimeRoute(string tenant, System.DateTime date, int id, CancellationToken cancellationToken);
		Task DateOnlyRoute(string tenant, System.DateOnly date, int id, CancellationToken cancellationToken);
		Task DateTimeOffsetRoute(string tenant, System.DateTimeOffset date, int id, CancellationToken cancellationToken);
		Task TimeOnlyRoute(string tenant, System.TimeOnly time, int id, CancellationToken cancellationToken);
		Task EnumRoute(string tenant, Test.Dto.Enums.MyEnum value, int id, CancellationToken cancellationToken);
	}
