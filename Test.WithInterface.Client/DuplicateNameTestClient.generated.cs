...
namespace Test.WithInterface.Client {
	public partial interface IDuplicateNameTestClient {
		Task Submit(int id, CancellationToken cancellationToken);
		Task Submit(string name, CancellationToken cancellationToken);
	}
	public partial class DuplicateNameTestClient : IDuplicateNameTestClient {
		public DuplicateNameTestClient(HttpClient client) {
			this.client = client;
