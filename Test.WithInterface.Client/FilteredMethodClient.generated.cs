...
namespace Test.WithInterface.Client {
	public partial interface IFilteredMethodClient {
		Task FilteredByNone(CancellationToken cancellationToken);
	}
	public partial class FilteredMethodClient : IFilteredMethodClient {
