...
namespace Test.WithInterface.Client {
	public partial interface IArrayParamTestClient {
		Task<string> ArrayStringParam(string[] array, CancellationToken cancellationToken);
		Task<string> ArrayValueType(int[] array, CancellationToken cancellationToken);
		Task<string> CollectionStringParam(System.Collections.Generic.IEnumerable<string> collection, CancellationToken cancellationToken);
		Task<string> CollectionValueType(System.Collections.Generic.IEnumerable<int> collection, CancellationToken cancellationToken);
		Task<string> CollectionNullableValueType(System.Collections.Generic.IEnumerable<System.Nullable<int>> collection, CancellationToken cancellationToken);
		Task<string> CollectionDateParam(System.Collections.Generic.IEnumerable<System.DateOnly> collection, CancellationToken cancellationToken);
		Task<string> CollectionNullableDateParam(System.Collections.Generic.IEnumerable<System.Nullable<System.DateOnly>> collection, CancellationToken cancellationToken);
		Task<string> CollectionDateTimeParam(System.Collections.Generic.IEnumerable<System.DateTime> collection, CancellationToken cancellationToken);
	}
	public partial class ArrayParamTestClient : IArrayParamTestClient {
