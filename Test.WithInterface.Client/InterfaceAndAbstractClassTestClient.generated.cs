...
namespace Test.WithInterface.Client {
	public partial interface IInterfaceAndAbstractClassTestClient {
		Task SubmitByInterface(Test.Dto.Classes.ICommand command, CancellationToken cancellationToken);
		Task SubmitByAbstractClass(Test.Dto.Classes.AbstractClass command, CancellationToken cancellationToken);
		Task<Test.Dto.Classes.ICommand> ReturnInterfaceAsync(CancellationToken cancellationToken);
		Task<Test.Dto.Classes.ICommand> ReturnInterface(CancellationToken cancellationToken);
		Task<Test.Dto.Classes.AbstractClass> ReturnAbstractClassAsync(CancellationToken cancellationToken);
		Task<Test.Dto.Classes.AbstractClass> ReturnAbstractClass(CancellationToken cancellationToken);
	}
	public partial class InterfaceAndAbstractClassTestClient : IInterfaceAndAbstractClassTestClient {
