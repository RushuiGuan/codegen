...
namespace Albatross.CodeGen.SqlServer {
	...
	public class TableMergeByID : TableQueryGenerator {
		...
		public override StringBuilder Build(StringBuilder sb, DatabaseObject t, SqlQueryOption options, ICodeGeneratorFactory factory) {
			...
			factory.Get<DatabaseObject, SqlQueryOption>("table_merge_join_by_id").Build(sb, t, options, factory).AppendLine();
			factory.Get<DatabaseObject, SqlQueryOption>("table_merge_update").Build(sb, t, options, factory).AppendLine();
