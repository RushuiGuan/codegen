	...
	public static partial class Extensions {
		public static IHttpClientBuilder AddClients(this IHttpClientBuilder builder) {
			return builder
				...
				.AddTypedClient<IDuplicateNameTestProxyService, DuplicateNameTestProxyService>()
				.AddTypedClient<IFilteredMethodProxyService, FilteredMethodProxyService>()
				.AddTypedClient<IFromBodyParamTestProxyService, FromBodyParamTestProxyService>()
				.AddTypedClient<IFromHeaderParamTestProxyService, FromHeaderParamTestProxyService>()
				.AddTypedClient<IFromQueryParamTestProxyService, FromQueryParamTestProxyService>()
				.AddTypedClient<IFromRoutingParamTestProxyService, FromRoutingParamTestProxyService>()
				.AddTypedClient<IHttpMethodTestProxyService, HttpMethodTestProxyService>()
