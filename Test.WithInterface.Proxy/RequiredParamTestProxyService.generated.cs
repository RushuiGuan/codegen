...
namespace Test.WithInterface.Proxy {
	public partial interface IRequiredParamTestProxyService {
		Task<string> ExplicitStringParam(string text);
		Task<string> ImplicitStringParam(string text);
		Task<string> RequiredStringParam(string text);
		Task<string> RequiredValueType(int id);
		Task<string> RequiredDateOnly(System.DateOnly date);
		Task<string> RequiredDateTime(System.DateTime date);
		Task RequiredPostParam(Test.Dto.Classes.MyDto dto);
		Task<string> RequiredStringArray(string[] values);
		Task<string> RequiredStringCollection(System.Collections.Generic.IEnumerable<string> values);
		Task<string> RequiredValueTypeArray(int[] values);
		Task<string> RequiredValueTypeCollection(System.Collections.Generic.IEnumerable<int> values);
		Task<string> RequiredDateOnlyCollection(System.Collections.Generic.IEnumerable<System.DateOnly> dates);
		Task<string> RequiredDateOnlyArray(System.DateOnly[] dates);
		Task<string> RequiredDateTimeCollection(System.Collections.Generic.IEnumerable<System.DateTime> dates);
		Task<string> RequiredDateTimeArray(System.DateTime[] dates);
