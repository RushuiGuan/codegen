...
namespace Test.WithInterface.Proxy {
	public partial interface IRequiredReturnTypeTestProxyService {
		...
		Task<string> GetActionResultString();
		Task<string> GetAsyncActionResultString();
		Task<int> GetInt();
		Task<int> GetAsyncInt();
		Task<int> GetActionResultInt();
		Task<int> GetAsyncActionResultInt();
	...
	public partial class RequiredReturnTypeTestProxyService : ClientBase, IRequiredReturnTypeTestProxyService {
		...
		public async Task<string> GetActionResultString() {
		...
		public async Task<string> GetAsyncActionResultString() {
		...
		public async Task<int> GetActionResultInt() {
		...
		public async Task<int> GetAsyncActionResultInt() {
