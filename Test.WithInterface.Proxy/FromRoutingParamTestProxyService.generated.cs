...
namespace Test.WithInterface.Proxy {
	public partial interface IFromRoutingParamTestProxyService {
		Task ImplicitRoute(string name, int id);
		Task ExplicitRoute(string name, int id);
		Task WildCardRouteDouble(string name, int id);
		Task WildCardRouteSingle(string name, int id);
		Task DateTimeRoute(System.DateTime date, int id);
		Task DateOnlyRoute(System.DateOnly date, int id);
		Task DateTimeOffsetRoute(System.DateTimeOffset date, int id);
		Task TimeOnlyRoute(System.TimeOnly time, int id);
